...
var styleScopePrefer = map[string][]string{
	"close":    {"全息瞄准镜", "全息二型瞄准镜", "AP5000反射式瞄准镜", "Cobra准直式瞄准镜", "微型瞄具增高架"},
	"mid":      {"棱镜通用二倍瞄准镜", "视点3倍瞄准镜", "HAMR组合瞄准镜", "全息瞄准镜"},
	"long":     {"3/7倍可调瞄准镜", "LPVO多倍率战斗镜", "M157火控系统", "视点3倍瞄准镜"},
	"balanced": {"棱镜通用二倍瞄准镜", "视点3倍瞄准镜", "HAMR组合瞄准镜", "全息瞄准镜"},
	"stealth":  {"棱镜通用二倍瞄准镜", "侦察型1.5/5倍可调镜", "视点3倍瞄准镜"},
}

// Weapon type → default scope preferences (based on knowledge: SMG=红点/全息, DMR/SR=高倍)
var weaponTypeScopePrefer = map[string][]string{
	"AR":  {"棱镜通用二倍瞄准镜", "视点3倍瞄准镜", "HAMR组合瞄准镜", "全息瞄准镜"},
	"SMG": {"全息瞄准镜", "全息二型瞄准镜", "AP5000反射式瞄准镜", "Cobra准直式瞄准镜", "微型瞄具增高架"},
	"DMR": {"HAMR组合瞄准镜", "3/7倍可调瞄准镜", "视点3倍瞄准镜", "LPVO多倍率战斗镜"},
	"SR":  {"6/12专家狙击镜", "光学狙击8倍镜", "PSO狙击8倍瞄准镜", "3/7倍可调瞄准镜"},
	"LMG": {"棱镜通用二倍瞄准镜", "视点3倍瞄准镜", "HAMR组合瞄准镜"},
}
